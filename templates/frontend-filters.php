...
<div class="flz-ags-filters">
	...
	<?php if (!$include_classes) : ?>
		...
		<?php echo $ui->field(array('type' => 'select', 'name' => 'sort_filter', 'label' => 'Sortierung', 'options' => array('default' => 'Vorgabe', 'title' => 'AG-Name', 'grade' => 'Klassenstufe', 'leader' => 'Dozent', 'weekday' => 'Wochentag'), 'attrs' => array('data-flz-ags-sort-select' => true))); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Renderer escaped die Komponente. ?>
	<?php endif; ?>
</div>
